# RDS for MySQL到Kafka同步实例<a name="drs_03_0037"></a>

本小节以RDS for MySQL-\>Kafka的出云同步为示例，介绍如何使用数据复制服务配置实时同步任务。
...
2.  在“同步实例”页面，填选区域、任务名称、任务异常通知信息、SMN主题、时延阈值、任务异常自动结束时间、描述、同步实例信息，单击“下一步”。
    ...
    **图 2**  RDS for MySQL到Kafka同步实例信息<a name="fig123764616489"></a>  
    ![](figures/RDS-for-MySQL到Kafka同步实例信息.png "RDS-for-MySQL到Kafka同步实例信息")
...
4.  在“设置同步“页面，选择同步策略、数据格式和同步对象，单击“下一步“。
    ...
    **图 5**  RDS for MySQL到Kafka同步模式<a name="fig14025637142814"></a>  
    ![](figures/RDS-for-MySQL到Kafka同步模式.png "RDS-for-MySQL到Kafka同步模式")
    ...
    **表 5**  同步对象
    ...
    <tbody><tr id="row2014903263913"><td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.3.1.1 "><p id="p515011320393"><a name="p515011320393"></a><a name="p515011320393"></a>DML同步</p>
    </td>
    <td class="cellrowborder" valign="top" width="84%" headers="mcps1.2.3.1.2 "><p id="p131508322395"><a name="p131508322395"></a><a name="p131508322395"></a>选择需要同步的DML操作，默认都勾选。</p>
    </td>
    </tr>
    <tr id="row61064915127"><td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.3.1.1 "><p id="p1107109131214"><a name="p1107109131214"></a><a name="p1107109131214"></a>同步Topic策略</p>
    </td>
...
5.  在“数据加工”页面，选择需要加工的列，进行列加工。
    ...
    **图 6**  RDS for MySQL到Kafka数据加工<a name="fig155445215364"></a>  
    ![](figures/RDS-for-MySQL到Kafka数据加工.png "RDS-for-MySQL到Kafka数据加工")
...
6.  在“预检查“页面，进行同步任务预校验，校验是否可进行实时同步。
    ...
    -   预检查完成后，且所有检查项结果均通过时，单击“下一步“。
        ...
        **图 7**  RDS for MySQL到Kafka预检查<a name="zh-cn_topic_0141892586_fig23361684715"></a>  
