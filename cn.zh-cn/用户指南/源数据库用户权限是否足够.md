...
<table><tbody><tr id="row61594327185836"><th class="firstcol" valign="top" width="11%" id="mcps1.2.3.1.1"><p id="p5647094919214"><a name="p5647094919214"></a><a name="p5647094919214"></a><strong id="b3847649919214"><a name="b3847649919214"></a><a name="b3847649919214"></a>预检查项</strong></p>
</th>
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.1.1 "><p id="p4177105819156"><a name="p4177105819156"></a><a name="p4177105819156"></a>源数据库用户权限是否足够。</p>
</td>
</tr>
<tr id="row60641190185836"><th class="firstcol" valign="top" width="11%" id="mcps1.2.3.2.1"><p id="p6497214519214"><a name="p6497214519214"></a><a name="p6497214519214"></a><strong id="b4787839319214"><a name="b4787839319214"></a><a name="b4787839319214"></a>描述</strong></p>
</th>
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.2.1 "><p id="p753422619223"><a name="p753422619223"></a><a name="p753422619223"></a>检查用户提供的源数据库帐号权限是否符合迁移要求。若权限不够，会导致迁移失败。</p>
</td>
</tr>
<tr id="row6916626185836"><th class="firstcol" rowspan="4" valign="top" width="11%" id="mcps1.2.3.3.1"><p id="p673974219214"><a name="p673974219214"></a><a name="p673974219214"></a><strong id="b6065768119214"><a name="b6065768119214"></a><a name="b6065768119214"></a>失败提示及<strong id="b479313413277"><a name="b479313413277"></a><a name="b479313413277"></a>处理建议</strong></strong></p>
</th>
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.3.1 "><p id="p1522554095120"><a name="p1522554095120"></a><a name="p1522554095120"></a><strong id="b8256211115211"><a name="b8256211115211"></a><a name="b8256211115211"></a>失败原因</strong>：源数据库连接失败，导致该项检查无法进行。</p>
...
<p id="p6600291219251"><a name="p6600291219251"></a><a name="p6600291219251"></a><a name="image54711203101821"></a><a name="image54711203101821"></a><span><img id="image54711203101821" src="figures/fwx514861-GAUSS-DBaaS-image-93f46f77-3699-430a-acff-b9b0008f8412.png" width="228.4275" height="187.53"></span><a name="image34415931101942"></a><a name="image34415931101942"></a><span><img id="image34415931101942" src="figures/fwx514861-GAUSS-DBaaS-image-ec44a796-c48c-4162-ac8a-9e44b75bc712.png" height="147.28223876953126" width="360.11402961731034"></span></p>
<div class="note" id="note177012853116"><a name="note177012853116"></a><a name="note177012853116"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p0719813312"><a name="p0719813312"></a><a name="p0719813312"></a>该项作为除华为云华东区域之外的其他区域参考标准。</p>
</div></div>
</td>
</tr>
<tr id="row1473417172716"><td class="cellrowborder" valign="top" headers="mcps1.2.3.3.1 "><p id="p5735197192715"><a name="p5735197192715"></a><a name="p5735197192715"></a><strong id="b11362151912719"><a name="b11362151912719"></a><a name="b11362151912719"></a>失败原因：</strong>填写的连接源数据库的用户权限不足，需要具备db_datareader、db_owner中的任一种权限,或者具备sysadmin的权限。</p>
...
<div class="note" id="note865743710296"><a name="note865743710296"></a><a name="note865743710296"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p18657103762916"><a name="p18657103762916"></a><a name="p18657103762916"></a>该项只作为涉及华为云华东区域的参考标准。</p>
</div></div>
</td>
</tr>
...
<tr id="row172623923919"><th class="firstcol" rowspan="7" valign="top" width="11%" id="mcps1.2.3.3.1"><p id="p1326213983911"><a name="p1326213983911"></a><a name="p1326213983911"></a><strong id="b3262793399"><a name="b3262793399"></a><a name="b3262793399"></a>失败提示及<strong id="b54353312273"><a name="b54353312273"></a><a name="b54353312273"></a>处理建议</strong></strong></p>
</th>
...
## MongoDB迁移场景<a name="section1275729103916"></a>
...
## Oracle-\>PostgreSQL迁移场景<a name="section11359183020213"></a>

**表 5**  源数据库用户权限是否足够

<a name="table153592030102112"></a>
<table><tbody><tr id="row123592030142114"><th class="firstcol" valign="top" width="11%" id="mcps1.2.3.1.1"><p id="p5359203013219"><a name="p5359203013219"></a><a name="p5359203013219"></a><strong id="b1935933062111"><a name="b1935933062111"></a><a name="b1935933062111"></a>预检查项</strong></p>
</th>
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.1.1 "><p id="p5359133032116"><a name="p5359133032116"></a><a name="p5359133032116"></a>源数据库用户权限是否足够。</p>
</td>
</tr>
<tr id="row93591230192114"><th class="firstcol" valign="top" width="11%" id="mcps1.2.3.2.1"><p id="p235903042110"><a name="p235903042110"></a><a name="p235903042110"></a><strong id="b936003015219"><a name="b936003015219"></a><a name="b936003015219"></a>描述</strong></p>
</th>
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.2.1 "><p id="p183601830142116"><a name="p183601830142116"></a><a name="p183601830142116"></a>检查用户提供的源数据库帐号权限是否符合迁移要求，若权限不够，会导致迁移失败。</p>
</td>
</tr>
<tr id="row6360113017213"><th class="firstcol" valign="top" width="11%" id="mcps1.2.3.3.1"><p id="p036017306214"><a name="p036017306214"></a><a name="p036017306214"></a><strong id="b1136083052118"><a name="b1136083052118"></a><a name="b1136083052118"></a>失败提示及<strong id="b8360123042112"><a name="b8360123042112"></a><a name="b8360123042112"></a>处理建议</strong></strong></p>
</th>
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.3.1 "><p id="p0686621112212"><a name="p0686621112212"></a><a name="p0686621112212"></a><strong id="b465513317226"><a name="b465513317226"></a><a name="b465513317226"></a>失败原因：</strong>源数据库用户权限不足。</p>
<p id="p96871421162212"><a name="p96871421162212"></a><a name="p96871421162212"></a><strong id="b92451537162214"><a name="b92451537162214"></a><a name="b92451537162214"></a>处理建议：</strong>建议将迁移用户赋予DBA权限后重新校验。</p>
</td>
</tr>
</tbody>
</table>
