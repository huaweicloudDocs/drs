# 源数据库与目标数据库的WAL\_BLOCK\_SIZE参数值是否相同<a name="drs_11_0062"></a>
...
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.3.1 "><p id="p58679261532"><a name="p58679261532"></a><a name="p58679261532"></a><strong id="b1466642645714"><a name="b1466642645714"></a><a name="b1466642645714"></a>不通过原因</strong>：源数据库与目标数据库的WAL_BLOCK_SIZE参数值不同。</p>
