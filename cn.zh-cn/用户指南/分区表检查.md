# 分区表检查<a name="drs_11_0115"></a>

## Oracle-\>PostgreSQL迁移场景<a name="section834844911539"></a>
...
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.1.1 "><p id="p59157410191053"><a name="p59157410191053"></a><a name="p59157410191053"></a>分区表检查。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.2.1 "><p id="p2174934014558"><a name="p2174934014558"></a><a name="p2174934014558"></a>不支持分区表的迁移，该项目是检查对象选择是否存在分区表，若存在，则导致迁移失败。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.3.1 "><p id="p1922623283013"><a name="p1922623283013"></a><a name="p1922623283013"></a><strong id="b839165483018"><a name="b839165483018"></a><a name="b839165483018"></a>失败原因：</strong>用户的对象选择选择了分区表。</p>
<p id="p7398373485"><a name="p7398373485"></a><a name="p7398373485"></a><strong id="b17206281884"><a name="b17206281884"></a><a name="b17206281884"></a>处理建议</strong>：建议在对象选择中去掉这些分区表。</p>
</td>
</tr>
</tbody>
</table>
