# DDM数据库到GaussDB\(DWS\)同步实例<a name="drs_03_0445"></a>

本小节以DDM-\>GaussDB\(DWS\)的实时同步为示例，介绍如何使用数据复制服务配置实时同步任务。
...
2.  在“同步实例”页面，填选区域、任务名称、任务异常通知信息、SMN主题、时延阈值、任务异常自动结束时间、描述、同步实例信息，单击“下一步”。
    ...
    **图 2**  DDM到GaussDB\(DWS\)同步实例信息<a name="fig123764616489"></a>  
    ![](figures/DDM到GaussDB(DWS)同步实例信息.png "DDM到GaussDB(DWS)同步实例信息")
    ...
    **表 2**  同步实例信息
    ...
    <td class="cellrowborder" valign="top" width="76.13%" headers="mcps1.2.3.1.2 "><p id="p87075558433"><a name="p87075558433"></a><a name="p87075558433"></a>此处以<span class="uicontrol" id="uicontrol12676440161816"><a name="uicontrol12676440161816"></a><a name="uicontrol12676440161816"></a>“公网网络”</span>为示例。目前支持可选公网网络、VPC网络、VPN和专线网络。</p>
    </td>
    </tr>
    ...
    <tr id="row16179161151319"><td class="cellrowborder" valign="top" width="23.87%" headers="mcps1.2.3.1.1 "><p id="p28953594518"><a name="p28953594518"></a><a name="p28953594518"></a>源端数据库实例个数</p>
    </td>
    <td class="cellrowborder" valign="top" width="76.13%" headers="mcps1.2.3.1.2 "><p id="p14946142295819"><a name="p14946142295819"></a><a name="p14946142295819"></a>源端数据库实例个数默认值为2，最大值为16，您需要根据源端实际的分片数据库个数设置该值大小。</p>
    </td>
    </tr>
...
3.  在“源库及目标库”页面，同步实例创建成功后，填选源库信息和目标库信息，建议您单击“源库和目标库“处的“测试连接“，分别测试并确定与源库和目标库连通后，勾选协议，单击“下一步“。
    ...
    **图 3**  DDM源库信息<a name="fig20498162055215"></a>  
    ![](figures/DDM源库信息.png "DDM源库信息")
    ...
    **表 3**  源库信息
    ...
    <tbody><tr id="zh-cn_topic_0135097933_row1265352355912"><td class="cellrowborder" valign="top" width="23.29%" headers="mcps1.2.3.1.1 "><p id="zh-cn_topic_0135097933_p665313232598"><a name="zh-cn_topic_0135097933_p665313232598"></a><a name="zh-cn_topic_0135097933_p665313232598"></a>中间件IP地址或域名</p>
    </td>
    ...
    <tr id="zh-cn_topic_0135097933_row9653102325913"><td class="cellrowborder" valign="top" width="23.29%" headers="mcps1.2.3.1.1 "><p id="zh-cn_topic_0135097933_p4653162320598"><a name="zh-cn_topic_0135097933_p4653162320598"></a><a name="zh-cn_topic_0135097933_p4653162320598"></a>中间件用户名</p>
    </td>
    <td class="cellrowborder" valign="top" width="76.71%" headers="mcps1.2.3.1.2 "><p id="p42011017556"><a name="p42011017556"></a><a name="p42011017556"></a>源数据库DDM中间件的用户名。</p>
    </td>
    </tr>
    <tr id="zh-cn_topic_0135097933_row065352315596"><td class="cellrowborder" valign="top" width="23.29%" headers="mcps1.2.3.1.1 "><p id="zh-cn_topic_0135097933_p86531023135911"><a name="zh-cn_topic_0135097933_p86531023135911"></a><a name="zh-cn_topic_0135097933_p86531023135911"></a>中间件密码</p>
    </td>
    <td class="cellrowborder" valign="top" width="76.71%" headers="mcps1.2.3.1.2 "><p id="p1820211715513"><a name="p1820211715513"></a><a name="p1820211715513"></a>源数据库DDM中间件用户名所对应的密码。</p>
    </td>
    </tr>
    ...
    <tr id="row9865181211575"><td class="cellrowborder" valign="top" width="23.29%" headers="mcps1.2.3.1.1 "><p id="p13866191295716"><a name="p13866191295716"></a><a name="p13866191295716"></a>数据库实例</p>
    </td>
    <td class="cellrowborder" valign="top" width="76.71%" headers="mcps1.2.3.1.2 "><p id="p12044542711"><a name="p12044542711"></a><a name="p12044542711"></a>根据源库实际的分片数据库，填写对应的数据库信息。</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 4**  目标库信息
    ...
    <a name="table86941416175"></a>
    <table><thead align="left"><tr id="row156945131719"><th class="cellrowborder" valign="top" width="23%" id="mcps1.2.3.1.1"><p id="p969481191719"><a name="p969481191719"></a><a name="p969481191719"></a><strong id="b156948101714"><a name="b156948101714"></a><a name="b156948101714"></a>参数</strong></p>
    </th>
    <th class="cellrowborder" valign="top" width="77%" id="mcps1.2.3.1.2"><p id="p5695171141716"><a name="p5695171141716"></a><a name="p5695171141716"></a><strong id="b15695813174"><a name="b15695813174"></a><a name="b15695813174"></a>描述</strong></p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="row769514111179"><td class="cellrowborder" valign="top" width="23%" headers="mcps1.2.3.1.1 "><p id="p96951214177"><a name="p96951214177"></a><a name="p96951214177"></a>数据库实例名称</p>
    </td>
    <td class="cellrowborder" valign="top" width="77%" headers="mcps1.2.3.1.2 "><p id="p13695111131712"><a name="p13695111131712"></a><a name="p13695111131712"></a>默认为创建同步任务时选择的<span id="text2168134316183"><a name="text2168134316183"></a><a name="text2168134316183"></a>GaussDB(DWS)</span>实例，不可进行修改。</p>
    </td>
    </tr>
    <tr id="row12695415178"><td class="cellrowborder" valign="top" width="23%" headers="mcps1.2.3.1.1 "><p id="p7695121121714"><a name="p7695121121714"></a><a name="p7695121121714"></a>数据库用户名</p>
    </td>
    <td class="cellrowborder" valign="top" width="77%" headers="mcps1.2.3.1.2 "><p id="p1569521191715"><a name="p1569521191715"></a><a name="p1569521191715"></a>目标数据库对应的数据库用户名。</p>
    </td>
    </tr>
    <tr id="row7695419175"><td class="cellrowborder" valign="top" width="23%" headers="mcps1.2.3.1.1 "><p id="p19695919175"><a name="p19695919175"></a><a name="p19695919175"></a>数据库密码</p>
    </td>
    <td class="cellrowborder" valign="top" width="77%" headers="mcps1.2.3.1.2 "><p id="p18695151101717"><a name="p18695151101717"></a><a name="p18695151101717"></a>数据库用户名和密码将被系统加密暂存，直至该任务删除后清除。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
4.  在“设置同步“页面，选择同步对象，单击“下一步“。
    ...
    **图 5**  DDM到GaussDB\(DWS\)同步模式<a name="fig32941637141913"></a>  
    ![](figures/DDM到GaussDB(DWS)同步模式.png "DDM到GaussDB(DWS)同步模式")

    **表 5**  同步模式和对象

    <a name="table112941737141919"></a>
    <table><thead align="left"><tr id="row2297183711193"><th class="cellrowborder" valign="top" width="16.1%" id="mcps1.2.3.1.1"><p id="p13297173717190"><a name="p13297173717190"></a><a name="p13297173717190"></a><strong id="b6297103751911"><a name="b6297103751911"></a><a name="b6297103751911"></a>参数</strong></p>
    </th>
    <th class="cellrowborder" valign="top" width="83.89999999999999%" id="mcps1.2.3.1.2"><p id="p1429715377197"><a name="p1429715377197"></a><a name="p1429715377197"></a><strong id="b5298037171914"><a name="b5298037171914"></a><a name="b5298037171914"></a>描述</strong></p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="row7298103791920"><td class="cellrowborder" valign="top" width="16.1%" headers="mcps1.2.3.1.1 "><p id="p12984372199"><a name="p12984372199"></a><a name="p12984372199"></a>同步对象</p>
    </td>
    <td class="cellrowborder" valign="top" width="83.89999999999999%" headers="mcps1.2.3.1.2 "><p id="p16298637101913"><a name="p16298637101913"></a><a name="p16298637101913"></a>可选表级同步、库级同步，您可以根据业务场景选择对应的数据进行同步。</p>
    <a name="ul14298153711196"></a><a name="ul14298153711196"></a><ul id="ul14298153711196"><li>选择数据的时候支持搜索，以便您快速选择需要的数据库对象。</li><li>如果有切换源数据库的操作，请在选择同步对象前单击右上角的<a name="image3298193715192"></a><a name="image3298193715192"></a><span><img id="image3298193715192" src="figures/kwx318612-GAUSS-DBaaS-image-a8fbc7b6-eab2-4798-b522-174e36341a92.png" width="17.660592827796844" height="15.80158165454858"></span>，以确保待选择的对象为最新源数据库对象。</li><li>在同步对象右侧已选对象框中，可以使用对象名映射功能进行源数据库和目标数据库中的同步对象映射，具体操作可参考<a href="对象名映射.md">对象名映射</a>。</li></ul>
    </td>
    </tr>
    </tbody>
    </table>
...
5.  在“数据加工“页面，选择需要加工的表对象，填写需要添加的列名、类型、操作类型信息，检查无误后，单击“下一步“。
    ...
    **图 6**  DDM到GaussDB\(DWS\)数据加工<a name="fig3318173591414"></a>  
    ![](figures/DDM到GaussDB(DWS)数据加工.png "DDM到GaussDB(DWS)数据加工")
...
6.  在“预检查“页面，进行同步任务预校验，校验是否可进行实时同步。
    ...
    -   预检查完成后，且所有检查项结果均通过时，单击“下一步“。
        ...
        **图 7**  DDM到MySQL预检查<a name="drs_03_0038_fig783414142414"></a>  
        ![](figures/DDM到MySQL预检查.png "DDM到MySQL预检查")
