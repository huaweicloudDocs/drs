...
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.2.1 "><p id="p4712357019306"><a name="p4712357019306"></a><a name="p4712357019306"></a>检查<span class="keyword" id="keyword398363218286"><a name="keyword398363218286"></a><a name="keyword398363218286"></a>目标数据库版本</span>是否属于MySQL 5.6.x和MySQL 5.7.x。</p>
</td>
</tr>
...
<tr id="row16487111814303"><td class="cellrowborder" valign="top" headers="mcps1.2.3.3.1 "><p id="p6647452123410"><a name="p6647452123410"></a><a name="p6647452123410"></a><strong id="b2319735113517"><a name="b2319735113517"></a><a name="b2319735113517"></a>失败原因</strong>：目标数据库版本不支持，目前只支持Microsoft SQL Server 2008、Microsoft SQL Server 2012、Microsoft SQL Server 2014的标准版和企业版。</p>
...
<div class="note" id="note73071545537"><a name="note73071545537"></a><a name="note73071545537"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p7308745031"><a name="p7308745031"></a><a name="p7308745031"></a>该项作为除华为云华东区域之外的其他区域参考标准。</p>
</div></div>
</td>
</tr>
<tr id="row588330936"><td class="cellrowborder" valign="top" headers="mcps1.2.3.3.1 "><p id="p161231114537"><a name="p161231114537"></a><a name="p161231114537"></a><strong id="b1512319141538"><a name="b1512319141538"></a><a name="b1512319141538"></a>失败原因</strong>：目标数据库版本不支持，目前只支持Microsoft SQL Server 2008。</p>
<p id="p112312149312"><a name="p112312149312"></a><a name="p112312149312"></a><strong id="b171231314833"><a name="b171231314833"></a><a name="b171231314833"></a>处理建议</strong>：建议使用符合迁移要求的数据库版本。</p>
<div class="note" id="note1592861814414"><a name="note1592861814414"></a><a name="note1592861814414"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p1392915186411"><a name="p1392915186411"></a><a name="p1392915186411"></a>该项只作为涉及华为云华东区域的参考标准。</p>
</div></div>
</td>
</tr>
...
## MongoDB迁移场景<a name="section1646116017327"></a>
