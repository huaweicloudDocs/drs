# DDM数据库到RDS for MySQL同步实例<a name="drs_03_0038"></a>

本小节以DDM-\>RDS for MySQL的入云实时同步为示例，介绍如何使用数据复制服务配置两个数据库实例之间的实时同步任务。
...
2.  在“同步实例”页面，填选区域、任务名称、任务异常通知信息、SMN主题、时延阈值、任务异常自动结束时间、描述、同步实例信息，单击“下一步”。
    ...
    **图 2**  DDM到MySQL同步实例信息<a name="fig123764616489"></a>  
    ![](figures/DDM到MySQL同步实例信息.png "DDM到MySQL同步实例信息")
    ...
    **表 2**  同步实例信息
    ...
    <td class="cellrowborder" valign="top" width="76.13%" headers="mcps1.2.3.1.2 "><p id="p168249357197"><a name="p168249357197"></a><a name="p168249357197"></a>选择DDM。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="76.13%" headers="mcps1.2.3.1.2 "><p id="p87075558433"><a name="p87075558433"></a><a name="p87075558433"></a>此处以公网网络为示例。目前支持可选公网网络和VPC网络。</p>
    </td>
    </tr>
    ...
    <tr id="row183713012714"><td class="cellrowborder" valign="top" width="23.87%" headers="mcps1.2.3.1.1 "><p id="p01021256155315"><a name="p01021256155315"></a><a name="p01021256155315"></a>同步实例所在子网</p>
    </td>
    ...
    <tr id="row1460252021111"><td class="cellrowborder" valign="top" width="23.87%" headers="mcps1.2.3.1.1 "><p id="p28953594518"><a name="p28953594518"></a><a name="p28953594518"></a>源端数据库实例个数</p>
    </td>
    <td class="cellrowborder" valign="top" width="76.13%" headers="mcps1.2.3.1.2 "><p id="p14946142295819"><a name="p14946142295819"></a><a name="p14946142295819"></a>源端数据库实例个数默认最小值为2，最大值为16，您需要根据源端实际的分片数据库个数设置该值大小。</p>
    </td>
    </tr>
    <tr id="row184864149149"><td class="cellrowborder" valign="top" width="23.87%" headers="mcps1.2.3.1.1 "><p id="p1017716536718"><a name="p1017716536718"></a><a name="p1017716536718"></a>企业项目</p>
    </td>
    ...
    <tr id="row208031220171418"><td class="cellrowborder" valign="top" width="23.87%" headers="mcps1.2.3.1.1 "><p id="p1276314133599"><a name="p1276314133599"></a><a name="p1276314133599"></a>标签</p>
    </td>
...
3.  在“源库及目标库”页面，同步实例创建成功后，填选源库信息和目标库信息，建议您单击“源库和目标库“处的“测试连接“，分别测试并确定与源库和目标库连通后，勾选协议，单击“下一步“。
    ...
    **图 4**  MySQL目标库信息<a name="fig1592113195219"></a>  
    ![](figures/MySQL目标库信息.png "MySQL目标库信息")
...
4.  在“设置同步“页面，选择同步对象，单击“下一步“。
    ...
    **图 5**  DDM到MySQL同步模式<a name="fig14025637142814"></a>  
    ![](figures/DDM到MySQL同步模式.png "DDM到MySQL同步模式")
    ...
    **表 5**  同步模式和对象
    ...
    <td class="cellrowborder" valign="top" width="84%" headers="mcps1.2.3.1.2 "><p id="p85921932191910"><a name="p85921932191910"></a><a name="p85921932191910"></a>同步对象支持表级同步，您可以根据业务场景选择对应的数据进行同步。选择对象的时候支持搜索，以便您快速选择需要的数据库对象。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
5.  在“预检查“页面，进行同步任务预校验，校验是否可进行实时同步。
    ...
    -   预检查完成后，且所有检查项结果均通过时，单击“下一步“。
        ...
        **图 6**  DDM到MySQL预检查<a name="fig783414142414"></a>  
