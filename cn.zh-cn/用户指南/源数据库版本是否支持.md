...
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.2.1 "><p id="p572477619290"><a name="p572477619290"></a><a name="p572477619290"></a>检查<span class="keyword" id="keyword1751752372810"><a name="keyword1751752372810"></a><a name="keyword1751752372810"></a>源数据库版本</span>是否属于MySQL 5.5.x、MySQL 5.6.x、MySQL 5.7.x。</p>
</td>
</tr>
