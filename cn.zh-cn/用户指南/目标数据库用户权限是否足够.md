...
## Oracle-\>MySQL、Oracle-\>TaurusDB数据库迁移、同步场景<a name="section941021413531"></a>
...
<tr id="row6641721152313"><th class="firstcol" valign="top" width="11%" id="mcps1.2.3.3.1"><p id="p1164142152319"><a name="p1164142152319"></a><a name="p1164142152319"></a><strong id="b1064162132315"><a name="b1064162132315"></a><a name="b1064162132315"></a>失败提示及<strong id="b18641122120235"><a name="b18641122120235"></a><a name="b18641122120235"></a>处理建议</strong></strong></p>
<p id="p20641121132312"><a name="p20641121132312"></a><a name="p20641121132312"></a></p>
</th>
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.3.1 "><p id="p116419212232"><a name="p116419212232"></a><a name="p116419212232"></a><strong id="b2641122115235"><a name="b2641122115235"></a><a name="b2641122115235"></a>失败原因：</strong>目标数据库权用户限不足，需要具备GRANT权限。</p>
...
<tr id="row117401348152813"><th class="firstcol" valign="top" width="11%" id="mcps1.2.3.3.1"><p id="p67402489289"><a name="p67402489289"></a><a name="p67402489289"></a><strong id="b1874024892810"><a name="b1874024892810"></a><a name="b1874024892810"></a>失败提示及<strong id="b574016480285"><a name="b574016480285"></a><a name="b574016480285"></a>处理建议</strong></strong></p>
</th>
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.3.1 "><p id="p1174094842817"><a name="p1174094842817"></a><a name="p1174094842817"></a><strong id="b197401348132816"><a name="b197401348132816"></a><a name="b197401348132816"></a>失败原因</strong>：同步任务填写的连接目标数据库的用户权限不足。</p>
