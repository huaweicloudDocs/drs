...
2.  在“选定备份”页面输入任务名称和描述，填选备份文件信息，单击“下一步”。
    ...
    **表 1**  任务信息
    ...
    <td class="cellrowborder" valign="top" width="81%" headers="mcps1.2.3.1.2 "><p id="drs_02_0010_p156871239182110"><a name="drs_02_0010_p156871239182110"></a><a name="drs_02_0010_p156871239182110"></a>任务名称在4-64位之间，必须以字母开头，不区分大小写，可以包含字母、数字、中划线或下划线，不能包含其他特殊字符。</p>
    </td>
    </tr>
    ...
    <tr id="drs_02_0010_row28941532862"><td class="cellrowborder" valign="top" width="19%" headers="mcps1.2.3.1.1 "><p id="drs_02_0010_p1276314133599"><a name="drs_02_0010_p1276314133599"></a><a name="drs_02_0010_p1276314133599"></a>标签</p>
    </td>
    <td class="cellrowborder" valign="top" width="81%" headers="mcps1.2.3.1.2 "><p id="drs_02_0010_p27631913145915"><a name="drs_02_0010_p27631913145915"></a><a name="drs_02_0010_p27631913145915"></a>可选配置，对迁移任务的标识。使用标签可方便管理您的迁移任务。每个任务最多支持10个标签配额。</p>
    <p id="drs_02_0010_p8307101212113"><a name="drs_02_0010_p8307101212113"></a><a name="drs_02_0010_p8307101212113"></a>任务创建成功后，您可以单击实例名称，在<span class="uicontrol" id="drs_02_0010_zh-cn_topic_0078078071_uicontrol1433412554316"><a name="drs_02_0010_zh-cn_topic_0078078071_uicontrol1433412554316"></a><a name="drs_02_0010_zh-cn_topic_0078078071_uicontrol1433412554316"></a>“标签”</span>页签下查看对应标签。关于标签的详细操作，请参见<a href="https://support.huaweicloud.com/usermanual-drs/drs_backup_tag.html" target="_blank" rel="noopener noreferrer">标签管理</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>

    **图 2**  备份文件信息<a name="fig87171057145713"></a>  
    ![](figures/备份文件信息-7.png "备份文件信息-7")
    ...
    **表 2**  备份文件信息
    ...
    <div class="note" id="note74816583435"><a name="note74816583435"></a><a name="note74816583435"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p39874152515"><a name="p39874152515"></a><a name="p39874152515"></a>Microsoft SQL Server的备份文件需要选择OBS桶目录下“.bak”格式的文件名，且可以同时选择多个备份文件。</p>
    </div></div>
    </td>
    </tr>
    </tbody>
...
3.  在“选定目标”页面，根据所选数据库类型，配置相应的数据库信息，单击“下一步”。
    ...
    **表 3**  Microsoft SQL Server数据库信息
    ...
    <div class="note" id="note656118358155"><a name="note656118358155"></a><a name="note656118358155"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p55611935101517"><a name="p55611935101517"></a><a name="p55611935101517"></a>仅支持指定需要恢复的数据库类型为“全部数据库”时重置数据库名。</p>
    </div></div>
    </td>
    </tr>
    ...
    <p id="p20246133172413"><a name="p20246133172413"></a><a name="p20246133172413"></a>待还原数据库名称必须与备份文件中的数据库名称一致，区分大小写，长度为1~64个字符，可以包含字母，数字、中划线和下划线，不能包含其他特殊字符。</p>
    ...
    <div class="note" id="note8261831202420"><a name="note8261831202420"></a><a name="note8261831202420"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p20877236161611"><a name="p20877236161611"></a><a name="p20877236161611"></a>支持选择多个数据库还原，目前最大配额为10个。</p>
    </div></div>
    </td>
    </tr>
    </tbody>
