# 源库包含无日志表\(UNLOGGED TABLE\)<a name="drs_11_0112"></a>

## PostgreSQL为源同步场景<a name="section14404223174716"></a>

**表 1**  源库包含无日志表\(UNLOGGED TABLE\)
...
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.1.1 "><p id="p59157410191053"><a name="p59157410191053"></a><a name="p59157410191053"></a>源库包含无日志表(UNLOGGED TABLE)。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.2.1 "><p id="p2174934014558"><a name="p2174934014558"></a><a name="p2174934014558"></a>检查源库包含无日志表(UNLOGGED TABLE)，若存在无日志表，则导致同步失败。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.3.1 "><p id="p7398373485"><a name="p7398373485"></a><a name="p7398373485"></a><strong id="b2039037134818"><a name="b2039037134818"></a><a name="b2039037134818"></a>待确认原因</strong>：源数据库包含无日志表(UNLOGGED TABLE)，对无日志表的修改不会记录日志, 因此进入增量同步后，UNLOGGED类型的表将无法同步增量数据。</p>
