...
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.3.1 "><p id="p1922623283013"><a name="p1922623283013"></a><a name="p1922623283013"></a><strong id="b839165483018"><a name="b839165483018"></a><a name="b839165483018"></a>不通过原因：</strong>源数据库存在没有索引（_id）的集合。</p>
<p id="p7398373485"><a name="p7398373485"></a><a name="p7398373485"></a><strong id="b17206281884"><a name="b17206281884"></a><a name="b17206281884"></a>处理建议</strong>：针对源数据库没有索引（_id）的集合手动添加索引，参考命令：db.集合名.ensureIndex({_id: 1})，如果创建索引不通过提示有重复的索引（_id）值，则不支持该集合的迁移。</p>
</td>
</tr>
</tbody>
</table>
