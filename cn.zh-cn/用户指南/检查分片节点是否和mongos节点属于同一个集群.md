...
<td class="cellrowborder" valign="top" width="89%" headers="mcps1.2.3.3.1 "><p id="p125951206366"><a name="p125951206366"></a><a name="p125951206366"></a><strong id="b35951920103617"><a name="b35951920103617"></a><a name="b35951920103617"></a>失败原因：</strong>分片节点和mongos节点不是同一个集群。</p>
